...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		copy: {
			...
			font: [
				{src: 'modules/core/client/css/MaterialIcons-Regular.eot', dest: 'public/dist/MaterialIcons-Regular.eot'},
				{src: 'modules/core/client/css/MaterialIcons-Regular.ttf', dest: 'public/dist/MaterialIcons-Regular.ttf'},
				{src: 'modules/core/client/css/MaterialIcons-Regular.woff', dest: 'public/dist/MaterialIcons-Regular.woff'},
				{src: 'modules/core/client/css/MaterialIcons-Regular.woff2', dest: 'public/dist/MaterialIcons-Regular.woff2'}
			]
		}
	});
	...
	grunt.registerTask('build', ['env:dev', 'lint', 'ngAnnotate', 'uglify', 'cssmin', 'copy:font']);
